...
// 		// here we hide all the different parts of our chart at the outset
// 		// so that we can reveal them later with the scroll
// 		d3.select(".x-axis")
// 			.attr("opacity", 0)
// 		d3.select(".y-axis")
// 			.attr("opacity", 0)
...
// 				show("circle")
// 				show("#year", 0.5)
// 				// let's check if the animation is running and turn it off if it is
// 				if (interval) {
// 					// clearInterval is a built-in JS function for cancelling an interval loop
